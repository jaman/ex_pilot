defmodule ExPilot.Web.Endpoint do
  ...
  plug(Plug.Static, at: "/", from: {:cauldron_2d_net, "priv/static"}, only: ~w(cauldron.js))

  plug(Plug.Static,
    at: "/",
    from: :ex_pilot,
    only: ~w(expilot.css expilot.js manifest.webmanifest icon.png)
  )
