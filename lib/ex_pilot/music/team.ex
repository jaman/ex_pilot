defmodule ExPilot.Music.Team do
  ...
  defp phalanx do
    ...
    chords = Score.cycles(["Dm!8", theme_chords, answer_chords, quiet_chords, theme_chords, answer_chords, coda_chords])
    roots = Score.roots(chords)

    theme = "[d3@3 d3 f3@2 g3@2] [a3@6 g3@2] [f3@3 f3 e3@2 f3@2] [d3@8] [d3@3 d3 f3@2 a3@2] [c4@6 a3@2] [a3@3 g3 f3@2 e3@2] [d3@6 ~@2]"
    answer = "[a3@3 a3 c4@2 d4@2] [e4@6 d4@2] [c4@3 c4 b3@2 c4@2] [a3@8] [a3@3 a3 c4@2 e4@2] [g4@6 e4@2] [e4@3 d4 c4@2 b3@2] [a3@6 ~@2]"
    coda = "[d3@3 d3 f3@2 a3@2] [c4@6 a3@2] [a3@3 g3 f3@2 e3@2] [d3@8] [f3@3 f3 e3@2 c3@2] [d3@8] [d3@6 ~@2] [~@8]"

    tattoo_soft = "[bd ~ [~ sd] [sd sd sd sd]]"
    tattoo = "[bd [~ sd] bd [sd*4 sd*2]]"
    tattoo_full = "[bd [bd sd] bd [sd*4 sd*2]]"
    drums = Score.cycles(["#{tattoo_soft}!8", "#{tattoo}!16", "~!8", "#{tattoo_full}!16", "#{tattoo}!8"])
    ...
    {56,
     %{
       ...
       bass: ~s|note("#{roots}").s("gm_contrabass").struct("<[x ~ ~ ~]!8 [x ~ x ~]!16 [x ~ ~ x]!8 [x ~ x [~ x]]!16 [x ~ x ~]!8>").gain(.5).clip(.9).release(.2)|,
       pad: ~s|chord("#{chords}").voicing().s("gm_string_ensemble_1").attack(.6).release(1.2).lpf(1500).gain("<.12!8 .16!16 .2!8 .18!16 .16!8>")|,
       lead:
  ...
  defp siege do
    ...
    chords = Score.cycles([assault_chords, assault_chords, climb_chords, break_chords, assault_chords, climb_chords])
    ...
    break_bass = "[d2 ~ ~ d2 ~ ~ d2 ~]!2 [bf1 ~ ~ bf1 ~ ~ bf1 ~]!2 [g1 ~ ~ g1 ~ ~ g1 ~]!2 [a1 ~ ~ a1 ~ ~ a1 ~]!2"
    bass = Score.cycles([assault_bass, assault_bass, climb_bass, break_bass, assault_bass, climb_bass])

    fanfare = "[d4@3 d4 d4@2 f4@2] [a4@6 ~@2] [a4@3 a4 bf4@2 a4@2] [f4@4 d4@4] [d4@3 d4 d4@2 f4@2] [a4@3 a4 c5@2 a4@2] [g4@3 f4 e4@2 cs4@2] [a4@3 a4 a4@2 cs5@2]"
    fanfare_2 = "[d4@3 d4 d4@2 f4@2] [a4@3 a4 g4@2 f4@2] [a4@3 a4 bf4@2 c5@2] [d5@4 a4@4] [d4@3 d4 d4@2 f4@2] [a4@3 a4 c5@2 d5@2] [e5@3 d5 cs5@2 e5@2] [a4@3 a4 a4@2 cs5@2]"
    climb = "[d4@3 e4 f4@3 e4] [f4@3 g4 a4@3 g4] [g4@3 a4 bf4@3 a4] [bf4@3 c5 d5@3 c5] [c5@3 d5 e5@3 d5] [e5@3 f5 e5@2 cs5@2] [d5@6 a4@2] [f5@2 e5@2 d5@4]"
    ...
    drums = Score.cycles([assault_group, assault_group, assault_group, "#{half}!7 #{half_fill}", assault_group, assault_group])
    ...
    {48,
     %{
       ...
       bass: ~s|note("#{bass}").s("gm_electric_bass_pick").gain("<.5!16 .55!8 .45!8 .5!8 .55!8>").clip(.6).lpf(800)|,
       pad: ~s|chord("#{chords}").voicing().s("gm_synth_strings_1").attack(.1).release(.5).gain("<.14!16 .16!8 .2!8 .16!16>")|,
       lead:
